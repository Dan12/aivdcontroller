...
public class OrientationSensor   implements  SensorEventListener, Drawable {
    ...
    public OrientationSensor(Context context, SensorEventListener parent) {
    ...
    public int Register(Activity activity) {
        ...
        m_OrientationOK = false;
        int count = 0;
        Sensor SensorGravity = m_sm.getDefaultSensor(Sensor.TYPE_ACCELEROMETER);
        System.out.println("No Grav"+(SensorGravity == null));
    ...
    public void onSensorChanged(SensorEvent evnt) {
        //System.out.println(evnt.sensor.getName());
    ...
    public void drawElements(Canvas canvas, Paint paint, float density) {
        ...
        canvas.drawText("H: " + (m_azimuth_radians*180/Math.PI), 5, 250, paint);
    }
}
